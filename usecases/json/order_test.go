...
func TestOrderInteractor_Show(t *testing.T) {
	...
	repositories.Spree_db.Create(&domain.Variant{Id: 2, ProductId: 2, CostPrice: &costPrice})
	...
	repositories.Spree_db.Exec("INSERT INTO spree_stock_items(variant_id, stock_location_id) values(2, 1)")
