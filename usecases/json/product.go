...
func (this *ProductInteractor) GetCreateResponse(params ResponseParameters) (interface{}, interface{}, error) {
	...
	if !ok {
		utils.LogrusError(utils.FuncName(), errors.New("Error occurred while parsing request parameters."))
...
func (this *ProductInteractor) mergeComplementaryValues(productIds []int64, productJsonSlice []*domain.Product) error {
	...
	if err != nil {
		utils.LogrusError(utils.FuncName(), errors.New("Error getting variants: "+err.Error()))
	...
	if err != nil {
		utils.LogrusError(utils.FuncName(), errors.New("Error getting product properties: "+err.Error()))
	...
	if err != nil {
		utils.LogrusError(utils.FuncName(), errors.New("Error getting classifications: "+err.Error()))
	...
	if err != nil {
		utils.LogrusError(utils.FuncName(), errors.New("Error getting option types: "+err.Error()))
