...
func (this AssetModel) TableName() string {
	return "spree_assets"
}

func (this AssetModel) AssetConfig(style string) (string, map[string]string) {
...
func (this AssetModel) AssetUrl(style string) string {
